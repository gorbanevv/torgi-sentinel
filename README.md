...
> ⚠️ **Важно про хостинг:** torgi.gov.ru блокирует IP дата-центров (проверено:
> Timeweb и Cloudflare WARP не проходят). Запускать бота нужно на резидентском или
> мобильном IP. Самый простой бесплатный способ — **старый Android-телефон + Termux**:
> см. **[TERMUX.md](TERMUX.md)**.
